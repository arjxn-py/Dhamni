...
if(isset($_POST['name'])){
    ...
    $pin = $_POST['pincode'];
    $sql = "INSERT INTO `bank`.`donor` (`name`, `age`, `sex` ,`blood_group`, `mobile`, `email`, `address`, `pincode`) VALUES ('$name', '$age', '$sex', '$groups', '$mobnum', '$email', '$address', '$pin')";
    // echo $sql;
...
<body>
    ...
    ?>
        <form action="index_donor.php" method="post">
    ...
    <script src="index_donor.js"></script>
